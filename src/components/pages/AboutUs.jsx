...
<div id='main' className='bg-white w-full min-h-0 dark:bg-black'>
  <div id="image" className='bg-black flex items-center justify-center py-5'>
    <img src="about-us.jpg" alt="" style={{width:'90%'}} className='rounded-3xl' />
  </div>
  ...
  <div id="image" className='bg-black flex items-center justify-center py-5'>
    <img src="tech-phones.jpeg" alt="" style={{width:'95%' }} className='rounded-3xl' />
  </div>
  ...
  <NavLink to={'/products'} className='pl-24'>Go to Products</NavLink>
  </div>



  <div id="image" className='bg-black flex items-center justify-center py-5'>
    <img src="commitment.jpg" alt="" style={{width:'95%' }} className='rounded-3xl' />
  </div>
  <div className='text-white h-4/5 inline-flex flex-col   w-full py-8 pl-10 pr-10 font-extrabold mt-3 text-3xl' style={{backgroundImage:`url('./black-abstract.png')`, backgroundSize:'cover',height:'40%'}}>
...
<div id="image" className='bg-black flex items-center justify-center py-5'>
    <img src="value.webp" alt="" style={{width:'95%' }} className='rounded-3xl' />
  </div>
